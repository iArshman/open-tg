...
TERABOX_REGEX = re.compile(
    r"https?://[^\s]*?(?:terabox|teraboxapp|teraboxshare|nephobox|1024tera|1024terabox|freeterabox|freeteraboxlink|terasharefile|terasharelink|mirrobox|momerybox|teraboxlink)\.[^\s]+",
    re.IGNORECASE
)
    ...
    async with semaphore:
        ...
        try:
            ...
            try:
                ...
                return {
                    "url": link,
                    "status": f"⚠️ Upload failed: {str(upload_error)}"
                }
